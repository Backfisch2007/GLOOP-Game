...
public class BowlingPin {
    ...
    public BowlingPin(double x, double z) {
        // 1. Reihe
        basis1 = new GLZylinder(-6.4, 5, 185, 2.5, 10); //Zylinder unten P1
        basis1.drehe(90, 90, 0); // Zylinder 90° gedreht 
        basis1.setzeFarbe(0, 100, 0); // Farbe
        oberteil1 = new GLKugel(-6.4, 11, 185, 3.25); // Kugel als oberer Teil P1
        oberteil1.setzeFarbe(0, 100, 0); // Farbe
        
        basis2 = new GLZylinder(6.4, 5, 185, 2.5, 10); //Zylinder unten P2
        basis2.drehe(90, 90, 0); // Zylinder 90° gedreht 
        basis2.setzeFarbe(0, 100, 0); // Farbe
        oberteil2 = new GLKugel(6.4, 11, 185, 3.25); // Kugel als oberer Teil P2
        oberteil2.setzeFarbe(0, 100, 0); // Farbe
        
        basis3 = new GLZylinder(-19.2, 5, 185, 2.5, 10); //Zylinder unten P3
        basis3.drehe(90, 90, 0); // Zylinder 90° gedreht 
        basis3.setzeFarbe(0, 100, 0); // Farbe
        oberteil3 = new GLKugel(-19.3, 11, 185, 3.25); // Kugel als oberer Teil P3
        oberteil3.setzeFarbe(0, 100, 0); // Farbe
        
        basis4 = new GLZylinder(19.2, 5, 185, 2.5, 10); //Zylinder unten P4
        basis4.drehe(90, 90, 0); // Zylinder 90° gedreht 
        basis4.setzeFarbe(0, 100, 0); // Farbe
        oberteil4 = new GLKugel(19.2, 11, 185, 3.25); // Kugel als oberer Teil P4
        oberteil4.setzeFarbe(0, 100, 0); // Farbe
        
        
        // 2. Reihe
        basis5 = new GLZylinder(0, 5, 175, 2.5, 10); //Zylinder unten P5
        basis5.drehe(90, 90, 0); // Zylinder 90° gedreht 
        basis5.setzeFarbe(100, 0, 0); // Farbe
        oberteil5 = new GLKugel(0, 11, 175, 3.25); // Kugel als oberer Teil P5
        oberteil5.setzeFarbe(100, 0, 0); // Farbe
        
        basis6 = new GLZylinder(-12.8, 5, 175, 2.5, 10); //Zylinder unten P6
        basis6.drehe(90, 90, 0); // Zylinder 90° gedreht 
        basis6.setzeFarbe(100, 0, 0); // Farbe
        oberteil6 = new GLKugel(-12.8, 11, 175, 3.25); // Kugel als oberer Teil P6
        oberteil6.setzeFarbe(100, 0, 0); // Farbe
        
        basis7 = new GLZylinder(12.8, 5, 175, 2.5, 10); //Zylinder unten P7
        basis7.drehe(90, 90, 0); // Zylinder 90° gedreht
        basis7.setzeFarbe(100, 0, 0); // Farbe  
        oberteil7 = new GLKugel(12.8, 11, 175, 3.25); // Kugel als oberer Teil P7
        oberteil7.setzeFarbe(100, 0, 0); // Farbe
        
        
        // 3. Reihe
        basis8 = new GLZylinder(-6.4, 5, 165, 2.5, 10); //Zylinder unten P8
        basis8.drehe(90, 90, 0); // Zylinder 90° gedreht 
        basis8.setzeFarbe(0, 0, 100); // Farbe
        oberteil8 = new GLKugel(-6.4, 11, 165, 3.25); // Kugel als oberer Teil P8
        oberteil8.setzeFarbe(0, 0, 100); // Farbe
        
        basis9 = new GLZylinder(6.4, 5, 165, 2.5, 10); //Zylinder unten P9
        basis9.drehe(90, 90, 0); // Zylinder 90° gedreht
        basis9.setzeFarbe(0, 0, 100); // Farbe  
        oberteil9 = new GLKugel(6.4, 11, 165, 3.25); // Kugel als oberer Teil P9
        oberteil9.setzeFarbe(0, 0, 100); // Farbe
        
        
        // 4. Reihe
        basis10 = new GLZylinder(0, 5, 155, 2.5, 10); //Zylinder unten P10
        basis10.drehe(90, 90, 0); // Zylinder 90° gedreht 
        basis10.setzeFarbe(0, 0, 100); // Farbe
        oberteil10 = new GLKugel(0, 11, 155, 3.25); // Kugel als oberer Teil P10
